package com.prowings.java8Features.streamApiProb;
...
public class Java8Streams {
	public static void main(String args[]) {  
		...
		// Create a List with String more than 2 characters filtered = strList.stream() .filter(x -> x.length()> 2) .collect(Collectors.toList()); 
